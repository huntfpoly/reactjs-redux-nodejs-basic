...
const Index = () => {
  ...
  const handleDeleteRow = async (event) => {
    const result = await CategoryApi.softDelete({ _id: selected })
  ...
  return (
    <React.Fragment>
      <MainCard title='Category' secondary={<SecondaryAction link='https://tablericons.com/' />}>
        <EnhancedTableToolbar numSelected={selected} onRemove={handleDeleteRow}/>
        ...
        {data.length > 0 ? (
                          ...
                          >
                            ...
                            <TableCell align='left'>
                              <Tooltip label='edit' title='edit'>
                                <IconButton>
                                  <Link to={`/admin/category/edit/${row.slug}`}>
          ...
          : <Typography variant='h4' align='center'>No data</Typography>
        }
