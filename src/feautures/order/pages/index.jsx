...
import { Alert, FormControl, InputLabel, MenuItem, Tooltip, Select } from '@material-ui/core';
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        <TableRow hover role="checkbox" aria-checked={isItemSelected} tabIndex={-1} key={row._id} selected={isItemSelected}>
                          ...
                          <TableCell align="left">{Intl.DateTimeFormat('en-US').format(new Date(row.updatedAt))}</TableCell>
                          <TableCell align="left">{numberFormatPrice(row.data.reduce((a, c) => a + c.total, 0))}</TableCell>
                          <TableCell align="left">{row.data.reduce((a, c) => a + c.quantity, 0)}</TableCell>
                          <TableCell align="left">
                            <FormControl fullWidth variant="standard">
                              <Select disabled id={row.status} value={row.status} label="Status" onChange={handleChange}>
